...
There are 2 ways to use ASC in old or new projects :
...
Unless otherwise stated, all ASC scripts are to be run on your computer (*local* host) from `/path/to/project/` as sudo or root.
