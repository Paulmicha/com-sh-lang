...
Being just "glue", ASC does not attempt to compete with existing tools (or workflows). Here's a list of articles, open-source projects and services I try to keep in mind when evaluating what belongs in ASC - and what does not.
