...
The general principle is : *file structure* should indicate intent. ASC's organization imbricates tasks (actions) by subject and/or fact(s) and/or preset(s), and the [semver convention](https://semver.org/) where appropriate.

Given ASC's minimalist ambition, dir/file naming could be just a principle.
