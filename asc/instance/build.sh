...
# $ make hook-debug s:instance p:pre a:build v:PROVISION_USING HOST_TYPE INSTANCE_TYPE
# $ make hook-debug s:instance a:build v:PROVISION_USING HOST_TYPE INSTANCE_TYPE
# $ make hook-debug s:instance p:post a:build v:PROVISION_USING HOST_TYPE INSTANCE_TYPE
#
# @example
#   make build
#   # Or :
