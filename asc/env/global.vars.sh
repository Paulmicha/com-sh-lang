...
global APP_GIT_INIT_HOOK "[ifnot-APP_GIT_ORIGIN]='' [default]=yes [help]='(y/n) Specify if some Git hooks should automatically trigger corresponding ASC hooks. WARNING : will overwrite existing git hook scripts during instance init.'"
