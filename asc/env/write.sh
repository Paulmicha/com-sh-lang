...
# file storing settings of the current local instance, asc/env/current/.app.vars.sh :
# - asc/env/dist/drupal/app.vars.sh.dist
# - asc/env/dist/drupal/scripts_provision.vars.sh.dist
# - asc/env/dist/drupal/7/app.vars.sh.dist
# - asc/env/dist/drupal/7/scripts_provision.vars.sh.dist
#
