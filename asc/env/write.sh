...
#
# @see asc/stack/lamp_deb/install.sh
# @see asc/db/get_credentials.sh
#
# Usage examples :
# . asc/env/write.sh live myproject.com www.myproject.com
# . asc/env/write.sh dev myproject.lan-0-40.io
# . asc/env/write.sh test test.myproject.com
#
