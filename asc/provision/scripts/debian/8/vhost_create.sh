...
# $ . asc/stack/lamp_deb/vhost_create.sh
# $ . asc/stack/lamp_deb/vhost_create.sh the-domain.com
# $ . asc/stack/lamp_deb/vhost_create.sh the-domain.com www.the-domain.com
#
...
if [[ -z "${1}" ]]; then
  ...
  # echo "Example : \$ . asc/stack/lamp_deb/vhost_create.sh the-domain.com"
  # return
