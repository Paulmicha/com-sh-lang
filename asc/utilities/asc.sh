...
#
# @example
#   extensions="$(u_asc_get extensions 'path/to/relative/dir')"
#   echo "$extensions"
#   # @see u_asc_get_extensible_words()
#
u_asc_get() {
  ...
  case "$p_type" in
    ...
    # @see u_asc_get_extensible_words()
    words)
      echo "$(u_asc_get_extensible_words $p_which_values $@)"
    ;;
...
#   words="$(u_asc_get_extensible_words subjects 'path/to/relative/dir' 'MY_NAMESPACE')"
#   echo "$words"
#   # Yields for ex. "app db env git provision remote stack test instance"
#
#   # Example with extensions.
#   words="$(u_asc_get_extensible_words extensions 'path/to/relative/dir' 'MY_NAMESPACE')"
#   echo "$words"
#   # Yields for ex. "predicates actions variants combos"
#
u_asc_get_extensible_words() {
  local p_suffix="$1"
  local p_path="$2"
  local p_namespace="$3"
