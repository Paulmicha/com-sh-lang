...
#
# Checks if its counterpart exists in asc/specific/overrides, and if it does,
...
#
# Checks if its counterpart exists in asc/specific/complements, and if it does,
...
u_autoload_get_complement() {
  local p_script_path="$1"
  local override=${p_script_path/asc/"asc/custom/complements"}
