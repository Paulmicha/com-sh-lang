...
# - asc/my_subject/my_action.docker-compose-2.3.hook.sh
# - asc/my_subject/my_action.dev.hook.sh
# - asc/my_subject/my_action.docker-compose.dev.hook.sh
# - asc/my_subject/my_action.docker-compose-2.3.dev.hook.sh
#
...
#   # - asc/<ASC_SUBJECTS>/bootstrap<.VARIANTS+semver>.hook.sh
#   # - $ASC_CUSTOM_DIR/<ASC_EXTENSIONS+semver>/<EXT_SUBJECTS>/bootstrap.hook.sh
#   # - $ASC_CUSTOM_DIR/<ASC_EXTENSIONS+semver>/<EXT_SUBJECTS>/bootstrap<.VARIANTS+semver>.hook.sh
#
#   # 2. When providing an action + a filter by subject :
#   hook -a 'init' -s 'stack'
#   # Yields the following lookup paths (ALL includes found are sourced) :
#   # - asc/stack/init.hook.sh
#   # - asc/stack/init<.VARIANTS+semver>.hook.sh
#   # - $ASC_CUSTOM_DIR/<ASC_EXTENSIONS+semver>/stack/init.hook.sh
#   # - $ASC_CUSTOM_DIR/<ASC_EXTENSIONS+semver>/stack/init<.VARIANTS+semver>.hook.sh
#
...
#   # Yields the following lookup paths (ALL includes found are sourced) :
#   # - $ASC_CUSTOM_DIR/extensions/nodejs<+semver>/<EXT_SUBJECTS>/<SUBJECT_ACTIONS><.INSTANCE_TYPE>.hook.sh
#
#   # 5. Prefixes filter :
