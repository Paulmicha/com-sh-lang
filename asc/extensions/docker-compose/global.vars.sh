...
global DC_STACK_VERSION "[default]=1 [help]='A number (integer) that is used for example when we upgrade one or more services (or the whole stack). See asc/extensions/docker-compose/stack/switch.sh'"
