...
#   # Or :
#   asc/extensions/remote/db/sync_from.sh my_remote_id
#   asc/extensions/remote/db/sync_from.sh my_remote_id new
#   asc/extensions/remote/db/sync_from.sh my_remote_id path/to/remote/dump/file.sql.tgz
#
