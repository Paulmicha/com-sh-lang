...
#   # Or :
#   asc/extensions/remote/db/sync_to.sh my_remote_id
#   asc/extensions/remote/db/sync_to.sh my_remote_id new
#   asc/extensions/remote/db/sync_to.sh my_remote_id path/to/local/dump/file.sql.tgz
#
