...
#   # Or :
#   asc/extensions/remote_traefik/remote/get_basic_auth.sh
#
#   # Specify target remote instance :
#   make remote-get-basic-auth 'stage'
#   # Or :
#   asc/extensions/remote_traefik/remote/get_basic_auth.sh 'stage'
#
...
asc/extensions/remote/remote/exec.sh "$p_remote_id" \
  asc/instance/registry_get.sh 'traefik_basic_auth_creds'
