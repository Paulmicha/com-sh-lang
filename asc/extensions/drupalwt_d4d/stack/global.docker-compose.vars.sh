...
#
# Latest tag at the time of writing : 5.4.24
# Uses the syntax for Linux (uid 1000 gid 1000).
# See https://github.com/wodby/docker4drupal/releases
# -> https://github.com/wodby/docker4drupal/blob/5.4.24/.env
#
...
global PHP_TAG "[if-DRUPAL_VERSION]=7 [true]='5.6-dev-4.13.18' [false]='7.4-dev-4.21.4' [index]=1"
