...
Extensions in `asc/extensions` can be enabled or disabled by overriding the file `asc/extensions/.asc_extensions_ignore` : copy/paste to `scripts/asc/override/.asc_extensions_ignore` and edit it (use 1 folder name per line to disable, or delete the line to enable).
