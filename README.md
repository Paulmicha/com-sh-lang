...
NB : some "artificial" advantage is given to the project-specific `./scripts` path in comparison to generic ASC extensions so that the custom implementations always take precedence over extensions'. Here's an example :
